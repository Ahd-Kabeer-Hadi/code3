...
export const HighImpactHero: React.FC<Page['hero']> = ({ links, media, HeroText, subText }) => {
  ...
  return (
    <section className="max-w-7xl w-full mx-auto flex flex-col flex-1 mt-10 md:mt-14 lg:mt-20 items-center min-h-screen relative">
      <div className="font-sans w-full ">
        <div className="max-w-5xl">
          <h1 className="mb-4 text-4xl font-bold md:text-5xl lg:text-6xl">{HeroText}</h1>
          {subText && <p className="my-6 text-2xl text-balance ">{subText}</p>}
        </div>
        <div>
      ...
      <div className="w-full flex flex-col min-h-[80vh] object-fill relative items-center justify-center text-foreground ">
